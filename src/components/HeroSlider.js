    ...
    <div className="relative w-full h-[50vh] lg:h-[90vh] overflow-hidden py-12">
      ...
      <div className="absolute inset-0">
        {slidesData.map((slide, index) => (
          ...
          >
            {/* Dark overlay applied only on the image */}
      ...
      {/* Slide Content */}
      <div className="relative z-30 flex flex-col justify-center lg:justify-end h-full px-6 md:px-12 lg:px-24 text-white">
                ...
                <div className="absolute inset-0 bg-black/20 flex items-center justify-center">
                  ...
                  >
                    <path
                      ...
                      strokeWidth={2}
                      d="M14.752 11.168l-4.586 2.664A1 1 0 019 12.84V7.16a1 1 0 011.166-.986l4.586 2.664a1 1 0 010 1.768z"
                    />
                  </svg>
                </div>
              )}
